...
namespace ASM.TraceabilityProxy.Service
{
	...
	public class Panel
	{
		...
		[EditorBrowsable(EditorBrowsableState.Advanced), XmlElement(Type = typeof(PanelId), ElementName = "id", Form = XmlSchemaForm.Qualified)]
		public List<PanelId> IDs
		{
			get
			{
				if (this.m_Ids == null)
				{
					this.m_Ids = new List<PanelId>();
				}
				return this.m_Ids;
			}
			set
