...
{
	[EditorBrowsable(EditorBrowsableState.Advanced), TypeConverter(typeof(ExpandableObjectConverter)), XmlType(TypeName = "spliceEvents")]
	[Serializable]
	public class SpliceEvent2_1
	{
		[XmlIgnore]
		private int m_nLoc;
