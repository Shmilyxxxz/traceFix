...
namespace ASM.TraceabilityProxy.Service
{
	...
	[Serializable]
	public class Panel2_1
	{
		[XmlIgnore]
		private List<PanelId2_1> m_Ids;
		...
		[EditorBrowsable(EditorBrowsableState.Advanced), XmlElement(Type = typeof(PanelId2_1), ElementName = "ref", Form = XmlSchemaForm.Qualified)]
		public List<PanelId2_1> IDs
		{
			get
			{
				if (this.m_Ids == null)
				{
					this.m_Ids = new List<PanelId2_1>();
				}
				return this.m_Ids;
			}
			set
